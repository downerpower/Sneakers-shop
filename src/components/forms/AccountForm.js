...
const AccountForm = ({
  ...
  return (
    <>
              ...
              {({ errors, touched, validateForm }) => (
                <Form className={styles.form}>
                  ...
                  <div
                    className={`${styles.inputField} ${
                      errors.password && touched.password
                        ? styles.errorField
                        : undefined
                    } ${isPasswordWrong && styles.errorField}`}
                  >
                    <Field
                      id="password"
                      className={
                        (errors.password && touched.password) || isPasswordWrong
                          ? styles.errorField
                          : undefined
                      }
                    ...
                    {isShown ? (
                      <svg
                        onClick={toggleShowPasswordClick}
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="24"
                        height="24"
                  ...
                  <button
                    ...
                    type="button"
                  >
                    <img src="./img/google.png" alt="google-logo" /> Log in with
                    Google
                  </button>
                  {isSignUpForm ? (
      ...
      {isLogged && !showMessage && (
        <p className={styles.message}>
          Welcome{!isSignUpForm && " back"}, {userName}!
        </p>
      )}
